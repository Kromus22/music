...
const likeBtn = document.querySelector('.player__controller-favorite');
...
const playMusic = event => {
  ...
  trackInfoTitle.innerHTML = `${track.track}`;
  trackInfoArtist.innerHTML = `${track.artist}`;
...
const updateTime = () => {
  ...
  const minutesDuration = Math.floor(duration / 60) || '00';
